...
Outcome_train = train_test_c_impute$Outcome[1:nrow(training_train)]
Outcome_test = train_test_c_impute$Outcome[(nrow(training_train)+1):(nrow(training_train)+nrow(training_test))]
Score_train = train_test_c_impute$Score[1:nrow(training_train)]
Score_test = train_test_c_impute$Score[(nrow(training_train)+1):(nrow(training_train)+nrow(training_test))]
